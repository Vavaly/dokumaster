        ...
        <div class="flex-1 overflow-y-auto main-content p-8">
            ...
            <div class="flex justify-between items-center mb-8">
                ...
                <div class="flex items-center space-x-4">
                    <div class="bg-white shadow rounded-full p-2 profile-img hover:border-2 transition">
                        <i class="ri-notification-line notification-icon"></i>
                    </div>
                    <img src="../public/images/pp.jpg" alt="Profil" class="h-10 w-10 rounded-full profile-img">
                </div>
            </div>

            <!-- Kartu Statistik -->
            <div class="grid grid-cols-4 gap-6 mb-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all hover-card">
                    <div class="flex justify-between items-center">
                        <div>
                            <h3 class="text-sm text-gray-500">Total Dokumen</h3>
                            <p class="text-2xl font-bold card-title">100</p>
                        </div>
                        <i class="ri-file-text-line text-3xl card-icon"></i>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all hover-card">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-2xl font-bold card-title">50</p>
                        </div>
                        <i class="ri-user-line text-3xl card-icon"></i>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all hover-card">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-2xl font-bold card-title">10</p>
                        </div>
                        <i class="ri-folder-add-line text-3xl card-icon"></i>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all hover-card">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-2xl font-bold card-title">75%</p>
                        </div>
                        <i class="ri-database-line text-3xl card-icon"></i>
                    </div>
                </div>
            </div>
