        ...
        <div class="relative w-full max-w-md bg-white rounded-2xl shadow-xl border border-gray-200">
            ...
            <div class="p-6">
                <form class="space-y-6" id="loginForm" action="login.php" method="POST">
                    <div>
                        <label for="email"
                            class="block w-full text-sm font-medium text-gray-700 mb-2">Email address</label>
                        ...
                        <div class="relative">
                            ...
                            <button type="button" id="togglePassword"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                    fill="currentColor">
                                    <path d="M2.5 10C3.857 6.865 6.6 5 10 5s6.143 1.865 7.5 5c-1.357 3.135-4.1 5-7.5 5S3.857 13.135 2.5 10z" />
                                    <path d="M10 12a2 2 0 100-4 2 2 0 000 4z" />
                                </svg>
                            </button>
                        </div>
